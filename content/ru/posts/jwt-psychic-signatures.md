...
function drawNormal() {
  ...
  var[qsx,qsy]=toSvg(Q.x,Q.y);s+='<line x1="'+qsx+'" y1="'+qsy+'" x2="'+(qsx+20)+'" y2="'+(qsy-32)+'" stroke="'+C.link+'" stroke-width="1" stroke-dasharray="3 3" opacity="0.6"/>';s+='<text x="'+(qsx-16)+'" y="'+(qsy-36)+'" fill="'+C.link+'" font-size="11" font-family="var(--font-mono)" text-anchor="start">Q (\u043f\u0443\u0431\u043b. \u043a\u043b\u044e\u0447)</text>';
